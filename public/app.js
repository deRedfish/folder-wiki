...
document.addEventListener("click", async (event) => {
  ...
  const adminFolderSelection = event.target.closest("[data-admin-folder-selection],[data-admin-folder-select-row]");
  if (adminFolderSelection) return toggleAdminFolderSelection(adminFolderSelection.dataset.adminFolderSelection || adminFolderSelection.dataset.adminFolderSelectRow);
